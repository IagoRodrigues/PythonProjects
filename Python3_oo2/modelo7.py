...
'''
Assim era minha playlist de programas.
...
O problema eh que ela nao era uma lista, entao nao consigo percorre-la. Vou transformar numa lista:
'''


class Playlist(list):  # Minha playlist agora eh uma lista
    def __init__(self, nome, programas):  # Dentro do construtor da minha lista
        super().__init__(programas)  # Chamo o construtor da classe list passando meus programas
        self.nome = nome  # Guardo o nome da minha playlist

    # Nao preciso de tamanho visto que list ja me da isso
...
# Outra maneira (mais correta) eh dizer que minha lista eh uma list, isso resolve o codigo abaixo
for programa in playlist_do_iago:
    print(programa)

# Posso usar o len de list:
print(f'Tamanho da playlist: {len(playlist_do_iago)}')